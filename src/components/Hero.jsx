          ...
          <div className="space-y-5 animate-fade-in-up">
            ...
            <div className="space-y-2">
              <h1 className="text-4xl md:text-5xl font-bold leading-tight text-slate-900">
                <span>Powerful API Performance</span>
                <span className="block">Testing, Minimal Code</span>
              </h1>

              <p className="text-base md:text-lg text-slate-600 leading-relaxed max-w-md">
                Generate concurrent traffic, analyze latency, and uncover
                bottlenecks with real-time performance insights.
              </p>
            </div>
            ...
            <div className="space-y-2">
              {[
                "Concurrent Load Testing with worker-pool architecture",
                "P50 / P95 / P99 Latency Analysis for detailed insights",
                "Throughput & Error Metrics with real-time tracking",
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <button
                ...
                className="group flex items-center justify-center space-x-2 px-6 py-3 bg-slate-900 hover:bg-slate-800 text-white rounded-lg font-semibold text-sm transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center space-x-2 px-6 py-3 border-2 border-slate-300 hover:border-slate-400 text-slate-900 rounded-lg font-semibold text-sm transition-all duration-200 bg-white hover:bg-slate-50"
              >
